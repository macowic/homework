# Generated by Django 3.0 on 2022-04-01 12:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.CharField(max_length=50, verbose_name='топик')),
                ('logo', models.ImageField(max_length=255, upload_to='homework/', verbose_name='лого')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_checked', models.BooleanField(default=False, verbose_name='проверен ли')),
                ('homework', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='university.Homework', verbose_name='домашняя работа')),
            ],
            options={
                'verbose_name': 'Файл',
